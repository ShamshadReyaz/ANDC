package com.mobiquel.lehbookingscanner.view.adapter
...
import kotlinx.android.synthetic.main.list_item_ckt.view.*
...
class CircuitListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.list_item_ckt, parent, false)
