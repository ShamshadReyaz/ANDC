...
class Preferences private constructor() {
    private val preferenceName = "com.mobiquel.srccapp"
    ...
    private val KEY_IS_LOGIN_DONE = "IS_LOGIN_DONE"
    ...
    fun loadPreferences(c: Context) {
        ...
        isLoginDone = preferences?.getString(KEY_IS_LOGIN_DONE, "0")
    ...
    fun savePreferences(c: Context) {
        ...
        editor?.putString(KEY_IS_LOGIN_DONE, isLoginDone)
